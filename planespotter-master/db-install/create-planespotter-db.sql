...
CREATE TABLE MASTER (`N-NUMBER` VARCHAR(255) NOT NULL,
...
LOAD DATA LOCAL INFILE '/planespotterCloud/planespotter-master/db-install/MASTER.txt'
INTO TABLE MASTER
...
LOAD DATA LOCAL INFILE '/planespotterCloud/planespotter-master/db-install/ACFTREF.txt'
INTO TABLE ACFTREF
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;
